...
const Hero = () => {
  return (
    ...
    <div className="min-h-screen  w-[80%] flex flex-col justify-center items-center md:flex-row md:items-start md:justify-between  md:w-[80%] mx-auto px-4 bg-[#355848]  md:h-[40vw] gap-3.5 mt-0 md:mt-20 z-10">
      <div className="text-center md:text-left max-w-lg w-full  space-y-4 flex-1 md:z-10">
        ...
        <div className="flex flex-col md:flex-row items-center  md:justify-evenly  w-full md:w-auto mt-10 md:mt-0 gap-5">
          <Button className="bg-[#780001] hover:bg-[#a31414] w-[80%] md:w-full xl:text-xl xl:h-10 2xl:text-2xl 2xl:h-15 rounded-3xl">
            Join us
          </Button>
          <Button className="bg-[#F1FAEE] hover:bg-[#FAEDD6] text-black w-[80%] md:w-full  xl:text-xl xl:h-10 2xl:text-2xl 2xl:h-15 rounded-3xl">
            Events
          </Button>
        </div>
      </div>
      <div className="flex-1 flex   md:flex items-center w-full md:w-auto align-middle mt-20 xl:mt-10 z-10 xl:justify-end">
